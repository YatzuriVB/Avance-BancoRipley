...
<head>
    ...
    <title>Mis Cuentas de Ahorro — Banco Ripley</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .account-saldo { font-size: 18px; font-weight: 700; color: #1a1a2e; }
...
<div class="main">
    <div class="topbar">
        <div class="topbar-title">Mis Cuentas de Ahorro</div>
        <div class="topbar-sub">Todas tus cuentas activas en Banco Ripley</div>
    </div>

    <div class="section">
        @forelse($cuentas as $cuenta)
        <a href="{{ route('cuenta.show', $cuenta->pkcuentaahorro) }}" class="account-item">
            <div class="account-left">
                <div class="account-icon"><i class="ti ti-building-bank"></i></div>
                <div>
                    <div class="account-code">{{ $cuenta->codcuentaahorro }}</div>
                    <div class="account-type">TEA {{ number_format($cuenta->tea, 2) }}%</div>
        ...
        @empty
        <div class="empty-state">No tienes cuentas de ahorro registradas</div>
        @endforelse
    </div>
</div>
